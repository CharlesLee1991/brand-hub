...
function StatusDot({ status }: { status: "active" | "syncing" | "idle" }) {
  const cls =
    status === "active"
      ? "w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_6px_rgba(0,196,140,0.5)]"
      : status === "syncing"
      ? "w-1.5 h-1.5 rounded-full bg-yellow-400 animate-pulse-dot"
      : "w-1.5 h-1.5 rounded-full bg-gray-500";
  return <span className={cls} />;
}

function StatusLabel({ status }: { status: "active" | "syncing" | "idle" }) {
  const map = { active: "Active", syncing: "Syncing", idle: "Idle" };
  return <span className="text-[11px] text-gray-500 tabular-nums">{map[status]}</span>;
}
      ...
      <div className="relative z-10">
        ...
        >
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div
                className="w-9 h-9 rounded-[10px] flex items-center justify-center font-extrabold text-[15px] text-white"
              ...
              <div className="flex flex-col">
                <div className="flex items-baseline gap-0.5">
                  <span className="font-display text-[20px] font-[750] tracking-tight text-white">
                    bmp
                  </span>
                  <span
                    className="font-display text-[20px] font-[750] tracking-tight"
                    style={{
                ...
                <span className="text-[10px] text-gray-500 tracking-[0.08em] font-medium uppercase leading-none">
                  Brand Management Platform
                </span>
              </div>
            </div>

            {/* AI Status + GEOcare Link */}
            <div className="flex items-center gap-4">
              ...
              >
                <span className="text-[10px] font-semibold text-gray-500 tracking-[0.06em] uppercase">
                  AI 연결
                </span>
                  ...
                  <div key={m.name} className="flex items-center gap-1.5">
                    <span
                      className={`text-xs font-medium ${
                        m.status === "active" ? "text-white" : "text-gray-400"
                      }`}
                    >
                      {m.name}
                    </span>
        ...
        <section className="pt-24 pb-20 px-6">
          ...
          >
            ...
            <h1 className="font-display text-5xl md:text-6xl font-bold leading-[1.15] mb-8 tracking-tight">
              AI가 학습한
              <br />
              <span
                style={{
            ...
            <p className="text-xl text-gray-400 mb-6 max-w-2xl mx-auto leading-relaxed">
              E-E-A-T 진단부터 PR-GEO 통합 실행까지
              <br />
              파트너사별 AI 어시스턴트가 브랜드 전략을 안내합니다.
            </p>

            {/* Feature Tags */}
            <div className="flex items-center justify-center gap-5 mt-10">
              {[
                { icon: Shield, label: "E-E-A-T 자동 진단", color: "var(--color-electric-blue)" },
                { icon: BarChart3, label: "Citation Moat 분석", color: "var(--color-emerald-green)" },
                { icon: Bot, label: "AI 어시스턴트", color: "#A78BFA" },
        ...
        <section className="pb-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div
              ...
              style={{
                opacity: loaded ? 1 : 0,
                animation: loaded ? "fadeUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.25s both" : "none",
              }}
            >
            ...
            {loading ? (
              ...
              <div
                ...
                style={{
                  opacity: loaded ? 1 : 0,
                  animation: loaded ? "fadeUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.35s both" : "none",
                }}
              >
                {agencies.map((hub) => (
                    ...
                    <div className="glass glass-gradient glass-hover p-7 cursor-pointer">
                      <div className="flex items-start gap-5">
                        <div
                          ...
                          style={{
                            background: `linear-gradient(135deg, ${hub.primary_color}, ${hub.primary_color}aa)`,
                          }}
                        >
        ...
        <section className="pb-24 px-6">
          <div className="max-w-7xl mx-auto">
            <h2
              className="font-display text-2xl font-bold text-center tracking-tight mb-14"
              style={{
                opacity: loaded ? 1 : 0,
                animation: loaded ? "fadeUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.4s both" : "none",
              }}
            >
              작동 방식
            </h2>
            <div
              ...
              style={{
                opacity: loaded ? 1 : 0,
                animation: loaded ? "fadeUp 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.45s both" : "none",
              }}
            >
              {[
                {
                  step: "01",
                  title: "E-E-A-T 자동 진단",
                  desc: "웹사이트의 Experience, Expertise, Authoritativeness, Trustworthiness를 AI가 분석합니다.",
                  icon: FileSearch,
                ...
                },
                {
                  step: "02",
                  title: "컴플라이언스 스크리닝",
                  desc: "의료광고법 등 업종별 규제 위반 사항을 자동 탐지하고 수정안을 제안합니다.",
                  icon: Shield,
                ...
                },
                {
                  step: "03",
                  title: "파트너 매칭 & 실행",
                  desc: "진단 결과에 따라 최적의 파트너사를 매칭하고 PR-GEO 통합 전략을 실행합니다.",
                  icon: Activity,
                ...
                <div key={item.step} className="glass glass-gradient glass-hover p-8 text-center">
                  <div
                    className={`w-14 h-14 rounded-2xl mx-auto mb-5 flex items-center justify-center bg-gradient-to-br ${item.gradient}`}
                  >
                  ...
                  <h3 className="font-display font-bold text-white mb-3 tracking-tight">
                    {item.title}
                  </h3>
        ...
        >
          <div className="max-w-7xl mx-auto flex items-center justify-between py-8 text-sm text-gray-500">
